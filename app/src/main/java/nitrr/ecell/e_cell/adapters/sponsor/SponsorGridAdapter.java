...
import nitrr.ecell.e_cell.fragments.SponsorsDetailsFragment;
import nitrr.ecell.e_cell.model.sponsors.SponsorDetail;

public class SponsorGridAdapter extends RecyclerView.Adapter<SponsorGridAdapter.ViewHolder> {

    private List<SponsorDetail> sponsorDetailList = new ArrayList<>();
    private Context context;
    private LayoutInflater layoutInflater;

    public SponsorGridAdapter(Context context) {
